  ...
  return (
    <Grid templateColumns="repeat(2, 1fr)" gap={10}>
      <GridItem colSpan={2} alignItems={'center'}>
        <Heading size="4xl" color={"#42446E"} fontWeight={"bold"}>Contact</Heading>
      </GridItem>
      <GridItem colSpan={2}>
        <Flex
      id="contact"
      ...
      <Stack gap={10}>
        ...
        <VStack align={"flex-start"} gap={10}>
          <HStack>
            ...
            <Text color="#555555">carlosdumar4@gmail.com</Text>
          </HStack>
          <HStack>
            <Box bgColor="#f0ecff" p="10px" rounded="5px">
              <FaGithub color="#8b52ff" />
            </Box>
            <Text color="#555555">github.com/carlosdumar4</Text>
          </HStack>
          <HStack>
            <Box bgColor="#f0ecff" p="10px" rounded="5px">
              <FaLinkedin color="#8b52ff" />
            </Box>
            <Text color="#555555">linkedin.com/in/carlos</Text>
          </HStack>
